...
phpunit:; docker compose -p $(COMPOSE_NAME) -f $(COMPOSE_DEV) --env-file $(COMPOSE_ENV) exec -T php vendor/phpunit/phpunit/phpunit -c phpunit.xml --display-warnings --fail-on-warning --display-deprecations
